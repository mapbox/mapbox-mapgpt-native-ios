...
struct MarketingVersion: ParsableCommand {
    ...
    func runReadmeVersionUpdate() throws {
        ...
        try replaceLineContaining(".package(url: \"https://github.com/mapbox/mapbox-mapgpt-ios.git\", from:",
                                  with: ".package(url: \"https://github.com/mapbox/mapbox-mapgpt-ios.git\", from: \"\(marketingVersion)\"),",
                                  in: readmeURL)
    }
